...
vote_data <- read.csv("D:/Mi unidad/Master FP IA y BD/7RO/R/house-votes-84.data",header=F, stringsAsFactors = FALSE) 
...
library(ROCR) 
pred <- prediction(predictions = pred$republican, labels = vote_raw_test$NAME)
#Curva ROC 
